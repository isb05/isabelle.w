...
FPS = 60 #frames per seconds, speed of game
BLACK = (0, 0, 0)
WHITE = (255, 255, 255)
RED = (255, 0, 0)
YELLOW = (255, 255, 0)
...
while game_running:
    ...
    #ensure platform stays within the screen bounds
    ...
    #draw score in orange rectanle at top left
    ...
    #draw the level indicator in light blue rectangle
    ...
    #draw lives in a red rectangle at the top left
